    ...
    for count in range(1):
        ...
        for i in range(Database.job_number):
            if i == 0:
                ...
                flag, wave_used, au_edges_list = RWA.route_wave_assign(AuGraph.edge_weight, i)
                # virtual_hop_cumulate += virtual_hFop_num
                print(i, "使用波长：", wave_used)
                # print(i, "虚拟拓扑跳数", virtual_hop_num, "累计虚拟拓扑跳数", virtual_hop_cumulate)
